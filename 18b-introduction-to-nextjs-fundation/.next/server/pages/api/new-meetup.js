...
async function handler(req, res) {
  if (req.method === "POST") {
    ...
    const client = await mongodb__WEBPACK_IMPORTED_MODULE_0__["MongoClient"].connect("mongodb+srv://practices:123ABCpractices@practices.socyj.mongodb.net/meetups?retryWrites=true&w=majority");
    const db = client.db();
    const meetupsCollection = db.collection("meetups"); // meetupsCollection.insertOne({
    //     title,
    //     image,
    //     address,
    //     description,
